...
//   stand_sub_ = this->create_subscription<std_msgs::msg::Bool>("stand_cmd", 1,
//                                                                      std::bind(&SpotMicroMotionCmd::standCommandCallback, this, _1));
  // idle cmd event subscriber
//   idle_sub_ = this->create_subscription<std_msgs::msg::Bool>("idle_cmd", 1, 
//                                                                     std::bind(&SpotMicroMotionCmd::idleCommandCallback, this,_1));
...
bool SpotMicroMotionCmd::publishServoConfiguration() {  
  ...
  i2cpwmboard::srv::ServosConfig temp_servo_config_array;
...
void SpotMicroMotionCmd::angleCommandCallback(
    const geometry_msgs::msg::Vector3::ConstPtr& msg) {
  cmd_.phi_cmd_ = msg->x;
